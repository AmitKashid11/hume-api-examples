  ...
  return (
    <div className="px-6 py-10 pb-20 sm:px-10 md:px-14">
      <div className="text-center md:text-left">
        <div className="pb-2 text-4xl font-medium text-neutral-700">AI - VERSE</div>
        <div className="pt-5">Select a modality to try out AI-VERSE's models with your webcam and microphone</div>
